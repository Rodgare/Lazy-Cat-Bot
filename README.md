...
Комманда /topm вызывает меню с кнопками, после нажатия на которые бот отправляет отчет топ 30 по выбранному босу с дпс или хпс среди игроков гильдии
(кнопки можно закрепть в канале для удобвства, взаимодействовать с ними могут все)
